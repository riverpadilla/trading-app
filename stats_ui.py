...
def interfaz_principal():
    ...
    # Crear slider después de definir variables y callbacks
    ...
    def cargar_estadisticas():
        ...
        try:
            ...
            if limit < 1 or limit > 10000:
                status_label.config(text="Error: Límite debe estar entre 1 y 10000", foreground="red")
                return
        except ValueError:
    ...
    ttk.Button(main_frame, text="Mostrar Estadísticas", command=cargar_estadisticas,
              width=25).pack(pady=10)
    
    ttk.Button(main_frame, text="Salir", command=root.destroy, width=25).pack(pady=5)
